...
function ProviderApplicationForm() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      // Admin notification — currently routed to okoli.chukie@gmail.com until
      // legal@xaepay.com mailbox is configured. Swap the recipient here when
      // the @xaepay.com mailboxes exist.
      sendEmail({ to: "okoli.chukie@gmail.com", subject: `New provider application · ${payload.legal_entity_name}`, html: adminHtml, text: `New provider application from ${payload.legal_entity_name}.\n\n${summary}` }).catch(() => {});
